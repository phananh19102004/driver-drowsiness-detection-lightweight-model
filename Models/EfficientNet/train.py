...
# Load EfficientNet-B0 & config classifier
model_ft = models.efficientnet_b0(weights=EfficientNet_B0_Weights.DEFAULT)
...
if __name__ == "__main__":
    ...
    torch.save(model_ft.state_dict(), 'drowsy_driver_efficientnet_b0.pth')